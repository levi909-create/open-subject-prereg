...
The dated event log of the Hope Longitudinal Record, moved here from
the README front page on 2026-08-26 purely for length; the entries
below are unedited and remain append-only. Every entry was written
when dated; nothing here is retrospective narration.
